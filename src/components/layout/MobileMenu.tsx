...
export const MobileMenu: React.FC<MobileMenuProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div
      className="fixed inset-0 z-[100] lg:hidden bg-[#07111F] text-[#F5F7FF] flex flex-col justify-between p-6 sm:p-8 pt-[calc(1.25rem+env(safe-area-inset-top))] pb-[calc(1.5rem+env(safe-area-inset-bottom))]"
      role="dialog"
      aria-modal="true"
